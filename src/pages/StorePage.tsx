          ...
          <aside className="space-y-3.5">
            <div className="sticky top-[72px] space-y-3.5">
              <div className="bg-[#25D366] rounded-2xl p-[18px] text-center text-white shadow-lg">
                ...
                <h3 className="text-[15px] font-black mb-1.5">Receba cupons em tempo real</h3>
                <p className="text-xs text-white/90 mb-4 leading-relaxed">Participe do nosso grupo e economize antes de todo mundo!</p>
