...
const BlogWhatsAppCTA = () => {
  ...
  return (
    <section className="overflow-hidden rounded-3xl bg-gradient-to-br from-[#25D366] to-[#128C7E] p-6 shadow-xl shadow-green-500/20">
      <div className="flex flex-col items-center gap-4 text-center md:flex-row md:text-left md:justify-between">
        ...
        <a 
          ...
          className="inline-flex items-center gap-2 rounded-xl bg-white px-6 py-3 text-sm font-black uppercase tracking-wide text-[#128C7E] transition-all hover:scale-105 hover:bg-gray-50 active:scale-95 shadow-md"
        >
